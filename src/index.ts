...
// Per documentation: For anything from @storagehub-sdk/core to work, initWasm() is required on top of the file.
console.log('🏁 Initializing WASM at the top level...');
await initWasm();
...
async function run() {
  try {
    ...
    console.log(`🔗 Transaction Link: https://testnet.datahaven.com/extrinsics/${txReceipt.transactionHash}`);
